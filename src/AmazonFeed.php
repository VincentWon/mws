...
class AmazonFeed extends AmazonFeedsCore
{
    ...
    public function __construct($s = null, $mock = false, $m = null, $config = null)
    {
        ...
        if (isset($this->env['THROTTLE_LIMIT_FEEDSUBMIT'])) {
            $this->throttleLimit = $this->env['THROTTLE_LIMIT_FEEDSUBMIT'];
        }
        if (isset($this->env['THROTTLE_TIME_FEEDSUBMIT'])) {
            $this->throttleTime = $this->env['THROTTLE_TIME_FEEDSUBMIT'];
        }
