...
/**
 * Core class for Nye Orders API.
 *
 * This is the core class for all objects in the Nye Orders section.
 * It contains no methods in itself other than the constructor.
 */
abstract class AmazonOrderCore extends AmazonCore
{
    /**
     * AmazonOrdersCore constructor sets up key information used in all Nye Orders Core requests
     *
     * This constructor is called when initializing all objects in the Nye Orders Core.
