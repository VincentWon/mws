 ...
 *
 * This Nye Orders Core object can retrieve a list of orders from Nye
...
class AmazonOrderList extends AmazonOrderCore implements \Iterator
{
    ...
    /**
     * Nye Order Lists pull a set of Orders and turn them into an array of <i>AmazonOrder</i> objects.
     *
    ...
    public function __construct($s = null, $mock = false, $m = null, $config = null)
    {
        ...
        if (isset($this->env['THROTTLE_TIME_ORDERLIST'])) {
            $this->throttleTime = $this->env['THROTTLE_TIME_ORDERLIST'];
        }
     ...
     * Setting this parameter tells Nye to only return Orders with statuses that match
     * those in the list. If this parameter is not set, Nye will return
     ...
     * Setting this parameter tells Nye to only return Orders made in marketplaces that match
     * those in the list. If this parameter is not set, Nye will return
     ...
     * Setting this parameter tells Nye to only return Orders with payment methods
     * that match those in the list. If this parameter is not set, Nye will return
     ...
     * Setting this parameter tells Nye to only return Orders with email addresses
     ...
     * Setting this parameter tells Nye to only return Orders with seller order IDs
     ...
     *
     * This method sets the maximum number of Feed Submissions for Nye to return per page.
     ...
     * Setting this parameter tells Nye to only return TFM Orders with statuses that match
     * those in the list. If this parameter is not set, Nye will return
    ...
    /**
     * Fetches orders from Nye and puts them in an array of <i>AmazonOrder</i> objects.
     *
     * Submits a <i>ListOrders</i> request to Nye. Nye will send
