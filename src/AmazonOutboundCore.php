...
abstract class AmazonOutboundCore extends AmazonCore
{
    ...
    public function __construct($s = null, $mock = false, $m = null, $config = null)
    {
        ...
        if (isset($this->env['AMAZON_VERSION_OUTBOUND'])) {
            $this->urlbranch = 'FulfillmentOutboundShipment/' . $this->env['AMAZON_VERSION_OUTBOUND'];
            $this->options['Version'] = $this->env['AMAZON_VERSION_OUTBOUND'];
        }
