...
class AmazonFeedList extends AmazonFeedsCore implements \Iterator
{
    ...
    public function __construct($s = null, $mock = false, $m = null, $config = null)
    {
        ...
        if (isset($this->env['THROTTLE_LIMIT_FEEDLIST'])) {
            $this->throttleLimit = $this->env['THROTTLE_LIMIT_FEEDLIST'];
        }
        if (isset($this->env['THROTTLE_TIME_FEEDLIST'])) {
            $this->throttleTime = $this->env['THROTTLE_TIME_FEEDLIST'];
        }
    }
